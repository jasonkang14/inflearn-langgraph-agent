...
user_deduction_chain = (
    user_deduction_prompt_template
    | small_llm
    | StrOutputParser()
)
...
@mcp.tool()
async def tax_deduction_tool(question: str) -> str:
    ...
    tax_deductible = await user_deduction_chain.ainvoke({
...
@mcp.tool()
async def house_tax_tool(tax_base_question: str, market_value_rate_question: str, tax_deductible_question: str, question: str) -> str:
